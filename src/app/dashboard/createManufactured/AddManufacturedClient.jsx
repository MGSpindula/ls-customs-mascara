...
export default function AddManufacturedClient({ onSubmit, onSearch }) {
  ...
  return (
    <div className="min-h-screen p-10 bg-gray-100">
      <form onSubmit={handleFormSubmit} className="bg-white p-8 max-w-xl mx-auto rounded-xl shadow">
